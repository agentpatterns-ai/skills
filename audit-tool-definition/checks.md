...
- **Note:** there is **no agentpatterns.ai corpus page** backing this; the only source is the auditor's
  `docs/agent-readiness/audit-tool-descriptions.md`. Do **not** ship it as a core normative ergonomics
  claim — flag-and-route only, pending a commissioned corpus page.
