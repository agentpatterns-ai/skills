...
- **Backlog wiring.** "OFFER to file" / "file" hands off to your backlog tracker (issue tracker) — one
  issue per opportunity, deduped (search before create). Interactive OFFERS; autonomous FILES.
